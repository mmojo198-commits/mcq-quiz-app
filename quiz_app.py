...
def handle_navigation(new_index):
    ...
    # We use .get() because the widget might not have updated session_state if no interaction occurred
...
if time_allowed is not None and not is_submitted and remaining is not None and remaining <= 0:
    ...
    # The widget value persists in session state even if not drawn yet in this run
