...
if "hint_interaction" not in st.session_state:
    st.session_state.hint_interaction = False
...
# ==========================================
# Skip timeout check if this rerun was triggered by hint interaction
if time_allowed is not None and not is_submitted and remaining is not None and remaining <= 0 and not st.session_state.hint_interaction:
...
# 1. Timer is active
# 2. Question is NOT submitted
# 3. Time is remaining
# 4. NOT a hint interaction (to prevent premature timeout)
